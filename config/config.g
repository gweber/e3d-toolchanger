...
M92 X100 Y100 Z1600 C91.022 E393.3:393.3:393.3:393.3	; Set steps per mm assuming x16 microstepping
...
M566 X400 Y400 Z60 C2 E2:2:2:2							; Set maximum instantaneous speed changes (mm/min)
...
M950 F7 C"duex.fan7"
;M950 F8 C"duex.fan8"
M950 F8 C"fan0" ; due to missing fan8 jumpers on duex, have to use alternative
...
G10 P0 X22 Y43 Z-5.25					; T0
G10 P1 X22.3 Y43 Z-5.45					; T1
G10 P2 X22.4 Y42.8 Z-5.65			    ; T2
G10 P3 X22.5 Y42.7 Z-5.4				; T3
...
;PID tuning
M307 H0 R1.340 C404.2 D2.85 S1.00 V24.1
M307 H1 R1.780 C225.8:184.3 D6.49 S1.00 V24.0
M307 H2 R1.643 C244.2:190.0 D7.18 S1.00 V24.0
M307 H3 R1.850 C237.7:177.6 D6.18 S1.00 V24.1
M307 H4 R1.800 C240.8:193.1 D7.25 S1.00 V24.1
